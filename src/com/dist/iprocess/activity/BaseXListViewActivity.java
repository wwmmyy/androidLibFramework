...
import com.dist.iprocess.base.BaseActivity;
...
public class BaseXListViewActivity extends BaseActivity  implements OnItemClickListener,
...
private int templogintime = 0; 
    ...
    protected int mainViewId() {
        ...
        return R.layout.base_xlistview_layout;
    }
...
//      标题top可见
        ...
        news_loading = (LinearLayout) findViewById(R.id.news_loading_progressbar);
        daiban_loading_error = (LinearLayout) findViewById(R.id.daiban_loading_error);
...
//        gw_search = (LinearLayout) findViewById(R.id.gw_search); 
//       initSearch(view);
    ...
    @Override
    public void dealTitle(RelativeLayout base_top2, TextView title, TextView pop_right,
            TextView base_top_right_tx2, ImageView base_top_right_im2) {
        // TODO Auto-generated method stub
...
//         metSearch.setText("");
//         mimgBtnClear = (ImageButton) findViewById(R.id.imgBtnClear);
...
//                   helper.getView(R.id.home_searchresult_name).setBackgroundDrawable(getResources().getDrawable(R.drawable.unread));
    ...
    private void onLoadNewMessage() {
        ...
        new Thread(new Runnable() { 
            String url = DistApp.serverAbsolutePath+"/mobileMeeting!getMeetMaterialList.action";//根据用户id获取应用程序的应用列表信息             @Override
            public void run() {  
                  ...
                  map.put("pageindex", "0");     
                  map.put("meetingId", "2143trgfgfdvb"); 
                   try {
