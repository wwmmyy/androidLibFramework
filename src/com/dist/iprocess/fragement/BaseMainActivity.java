...
import com.dist.iprocess.test.MyServiceTestActivity;
 ...
 */
public class BaseMainActivity extends BaseFragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ImageView testConpontent = (ImageView) findViewById(R.id.base_top_right_im);
		testConpontent.setVisibility(View.VISIBLE);
		testConpontent.setOnClickListener(new OnClickListener()
		 {
		 @Override
		 public void onClick(View v) {
		 // TODO Auto-generated method stub
		
		Intent test=new Intent(getApplicationContext(), MyServiceTestActivity.class);
		startActivity(test);
		...
		mViewPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				for (int i = 0; i < tabSize; i++) {
					...
					tab_bar[i].setBackgroundColor(i == position ? Color.rgb(
							220, 220, 220) : Color.parseColor("#FFFFFF"));
				}
	...
	private void setUpMenu() {
		...
		for (int i = 0; i < tabSize; i++) {
			tab_bar[i] = (RadioButton) findViewById(tab_barid[i]);
		}
		tab_bar[0].setChecked(true);
	}
	...
	public void onCheckedChanged(RadioGroup arg0, int checkedId) {
		for (int i = 0; i < tabSize; i++) {
			tab_bar[i] = (RadioButton) findViewById(tab_barid[i]);
			if (tab_barid[i] == checkedId) {
				mViewPager.setCurrentItem(i);
				// tab_bar[i].setBackgroundColor(Color.parseColor("#87CEFA"));
				tab_bar[i].setBackgroundColor(Color.rgb(220, 220, 220));
			} else {
				tab_bar[i].setBackgroundColor(Color.parseColor("#FFFFFF"));
			}
		}
	}
