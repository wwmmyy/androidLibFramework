 ...
 *      setContentView(R.layout.activity_main); 
                {
                        ...
                        label.setTargetView(findViewById(R.id.image2), 12,
                                        ...
                                        new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                        ...
                                                        Toast.makeText(MainActivity.this,
                                                                        "Kunqu label remove", Toast.LENGTH_SHORT)
                                                                        .show();
                                                }
                                        });
                } 
 ...
 * 
 */
public class BaseView_LabelView extends TextView {
    ...
    public BaseView_LabelView(Context context) {
        this(context, null);
    }

    public BaseView_LabelView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    @SuppressLint("NewApi")
	public BaseView_LabelView(Context context, AttributeSet attrs, int defStyle) {
