 ...
 */
public class BaseGestureLockView extends View{
	/**解锁密码key*/
	private String key="";
	...
	//=================================start=构造方法========================
	public BaseGestureLockView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}
	
	public BaseGestureLockView(Context context, AttributeSet attrs) {
